...
public class Main5Activity extends AppCompatActivity {
    ...
    private void listen(){
        ...
        try {
            ...
            Toast.makeText(Main5Activity.this, "Your device doesn't support Speech Recognition", Toast.LENGTH_SHORT).show();
        }
    }
                ...
                if(result.get(0).equals("cancel"))
                {
                    ...
                    switch (numberOfClicks) {
                        case 1:
                            ...
                            To.setText(to);
                            if (to.equals("123")) {
                                speak("thanks. you are succesfully logged in.");
